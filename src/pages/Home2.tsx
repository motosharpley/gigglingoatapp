        ...
        >
          ...
          <div id="about" style={{ padding: '20px 0' }}>
            ...
            >
              ...
              battles on Solana. Trade on Raydium, vote for dank memes with
              GIGL, and stake in our farm to earn rewards!
            </p>
            <IonButton
              expand="block"
              color="secondary"
          ...
          >
            ...
            <p style={{ color: '#fff' }}>
              150M GIGL airdrop for early users who join, vote, or meme. Follow
              us and get in on the action!
            </p>
            <IonButton
              color="success"
              href="https://discord.gg/example"
        ...
        <IonFooter>
          <IonToolbar color="dark">
            <p style={{ textAlign: 'center', fontSize: '0.9em' }}>
              ...
              <a
                href="mailto:contact@giglcoin.com"
                style={{ color: '#00ff00' }}
              >
                Contact
              </a>{' '}
